...
def _apply_sam_transform_if_applicable(template: dict) -> dict:
    ...
    try:
        ...
        raise ValueError(
            "Template uses the AWS::Serverless-2016-10-31 transform but the "
            "'aws-sam-translator' package is not installed; install ministack's "
            "'full' extra to enable SAM support"
        ) from e
