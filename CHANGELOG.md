...
- **CI — the MQTT/WebSocket test surface now runs** — CI installs `websockets`, so `tests/test_iot_data.py` (broker connect/publish/subscribe, retained messages, QoS 1, LWT) is executed instead of `importorskip`-skipped.
