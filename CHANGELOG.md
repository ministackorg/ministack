...
- **Glue — Iceberg-Spark catalog for Glue 5.0** — jobs declaring `GlueVersion` 5.0 resolve the Iceberg-Spark catalog, covering the dispatch and parse differences between Spark 3.5 and 3.3 and Iceberg v3.
